...
class Book(models.Model):
    ...
    author = models.ForeignKey(Author,verbose_name="yazarın_ismi",on_delete=models.CASCADE)
    description = models.TextField(blank=True, null=True)
    category = models.ManyToManyField(Category,verbose_name="kategori")
    publisher = models.ForeignKey(Publisher,on_delete = models.CASCADE, verbose_name="yayin_evi")
